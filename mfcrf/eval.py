...
parser = argparse.ArgumentParser(description='MFCRFs PyTorch implementation.', fromfile_prefix_chars='@')
...
def main_worker(args):
    ...
    # CRF model
    model = MFCRFDepth(version=args.encoder, inv_depth=False, max_depth=args.max_depth, pretrained=None)
    model.train()

...
# Argument Parser
parser = argparse.ArgumentParser(description='MFCRF Live 3D')
parser.add_argument('--model_name',      type=str,   help='model name', default='mfcrfs')
...
def load_model():
    args.mode = 'test'
    model = MFCRFDepth(version='large07', inv_depth=False, max_depth=args.max_depth)
...
class Window(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(self.tr("MFCRF Live"))
